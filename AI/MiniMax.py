...
def move_minimax(board, depth, player,info,end:bool,x=None,y=None,eva=evaluation,d=None):
    tem0_board = deepcopy(board)
    tem0_info = deepcopy(info)
    if end:
        d = depth
    ...
    while depth > 0:
        ...
        if player == 'black':
            ...
            for [x, y] in possible_moves:
                # print('thinking',x,y)
                tem_score = move_minimax(tem0_board,depth,'white',tem0_info,False,x,y,d=d)
                # print(tem_score)
                if tem_score > score:
                    score = tem_score
                    move = [x,y]
            ...
            for [x, y] in possible_moves:
                # print('thinking',x,y)
                tem_score = move_minimax(tem0_board,depth,'black',tem0_info,False,x,y,d=d)

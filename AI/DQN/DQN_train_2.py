...
if __name__ == "__main__":
    ...
    csv_path = Train_path + '\\' + 'DQN_train_2_log' +\
    ...
    for episode in range(EPISODE * 5):
        ...
        if (episode + 1) % 100 == 0:
            torch.save(offensive.Q.state_dict(), 'D:\\Durham\\Project\\code\\AI\\DQN\\model_offensive_2.pth.pth')
            torch.save(defensive.Q.state_dict(), 'D:\\Durham\\Project\\code\\AI\\DQN\\model_defensive_2.pth.pth')
            # break
